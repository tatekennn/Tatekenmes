...
export default function ProfilePage() {
  ...
  const timeline = [
    ...
    { title: '退勤後', body: 'まっすぐ帰る日もありますし、少し気分を切り替えたくて寄り道する日もあります。帰り道で気になったことは、あとで思い出せるように軽くメモしています。' },
    { title: '記録する理由', body: 'あとから振り返ったときに、その日のことをちゃんと思い出せるようにしておきたいからです。大げさに書くというより、自分の中で整理するために残しています。' },
  ];
