...
- ゲーム: `game.覇気.com` / `/game` で遊べる3D風アーケード「覇気ドーム3D」
...
curl -L https://game.xn--7qwx14d.com | grep '覇気ドーム3D'
```
...
- `game.xn--7qwx14d.com` または `/game` HTML内に `覇気ドーム3D` が含まれる
